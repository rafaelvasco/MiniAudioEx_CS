...
public delegate void AudioProcessEvent(AudioBuffer<float> framesOut, ulong frameCount, int channels);
public delegate void AudioReadEvent(AudioBuffer<float> framesOut, ulong frameCount, int channels);
...
public sealed class AudioSource : IDisposable
{
    ...
    public ulong Cursor
    {
        get => Library.ma_ex_audio_source_get_pcm_position(handle);
        set => Library.ma_ex_audio_source_set_pcm_position(handle, value);
    }
    ...
    /// </summary>
    /// <value></value>
    public ulong Length => Library.ma_ex_audio_source_get_pcm_length(handle);
    ...
    public float Volume
    {
        get => Library.ma_ex_audio_source_get_volume(handle);
        set => Library.ma_ex_audio_source_set_volume(handle, value);
    }
    ...
    public float Pitch
    {
        get => Library.ma_ex_audio_source_get_pitch(handle);
        set => Library.ma_ex_audio_source_set_pitch(handle, value);
    }
    ...
    public bool Loop
    {
        get => Library.ma_ex_audio_source_get_loop(handle) > 0;
        set => Library.ma_ex_audio_source_set_loop(handle, value ? (uint)1 : 0);
    }
    ...
    public bool Spatial
    {
        get => Library.ma_ex_audio_source_get_spatialization(handle) > 0;
        set => Library.ma_ex_audio_source_set_spatialization(handle, value ? (uint)1 : 0);
    }
    ...
    {
        get => Library.ma_ex_audio_source_get_doppler_factor(handle);
        set => Library.ma_ex_audio_source_set_doppler_factor(handle, value);
    }
    ...
    {
        get => Library.ma_ex_audio_source_get_min_distance(handle);
        set => Library.ma_ex_audio_source_set_min_distance(handle, value);
    }
    ...
    {
        get => Library.ma_ex_audio_source_get_max_distance(handle);
        set => Library.ma_ex_audio_source_set_max_distance(handle, value);
    }
    ...
    {
        get => (AttenuationModel)Library.ma_ex_audio_source_get_attenuation_model(handle);
        set => Library.ma_ex_audio_source_set_attenuation_model(handle, (ma_attenuation_model)value);
    }
    ...
    public Vector3f Direction
    {
        ...
        set => Library.ma_ex_audio_source_set_direction(handle, value.x, value.y, value.z);
    }
    ...
    public Vector3f Velocity
    {
        ...
        set => Library.ma_ex_audio_source_set_velocity(handle, value.x, value.y, value.z);
    }
    ...
    /// </summary>
    /// <value></value>
    public bool IsPlaying => Library.ma_ex_audio_source_get_is_playing(handle) > 0;
    ...
    private void OnProcess(IntPtr pUserData, IntPtr pSound, IntPtr pFramesOut, ulong frameCount, uint channels)
    {
        ...
        Process(framesOut, frameCount, (int)channels);
    }
    ...
    /// <param name="frameCount"></param>
    /// <param name="channels"></param>
    private void OnWaveform(IntPtr pUserData, IntPtr pFramesOut, ulong frameCount, uint channels)
    {
        int length = (int)(frameCount * channels);            
...
{
    void OnProcess(AudioBuffer<float> framesOut, ulong frameCount, int channels);
    void OnDestroy();
}
...
{
    void OnGenerate(AudioBuffer<float> framesOut, ulong frameCount, int channels);
    void OnDestroy();
}